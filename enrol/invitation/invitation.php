...
if ($data and confirm_sesskey()) {
	...
	$sent_result = "Sent result status:\r\n\r\n";
    foreach ($email_list as $email) {
        $data->email = $email;
        if($invitationmanager->send_invitations($data)){
	        $sent_result .= "Email: $email, Status: OK\r\n";
        } else {
	        $sent_result .= "Email: $email, Status: Not sent!\r\n";
        }
    }
    ...
    echo $OUTPUT->confirm($sent_result, $sectret, $courseret);
